...
// todo: fazer widget_ids! macro para minic para ids de imagens ou encontrar
// outra solução para simplificar adição de novas imagens para o código
struct Imgs {
    menu_button: ImgId,
