...
#[derive(Copy, Clone)]
pub struct Bone {
    parent: Option<u8>, // deve ser menos que o index de bone atual
...
impl Skeleton {
    ...
    pub fn bone(&self, bone_idx: u8) -> &Bone {
        &self.bones[bone_idx as usize]
    }

    pub fn bone_mut(&mut self, bone_idx: u8) -> &mut Bone {
        &mut self.bones[bone_idx as usize]
    }
